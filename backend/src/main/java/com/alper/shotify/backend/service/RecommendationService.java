...
import com.alper.shotify.backend.util.SongConverter;
...
public class RecommendationService {
    ...
    public RecommendationResponseDTO createRecommendation (CreateRecommendationRequestDTO requestDTO){
        ...
        List<SongEntity> songs = songConverter.convertToSongEntities(requestDTO.getRecommendedSongs().getRecommendedSongs());
